...
GAME_REWARDS_PROCESSED = {
    e.COIN_COLLECTED: 1,
    e.KILLED_OPPONENT: 5,
    e.CRATE_DESTROYED: 0.9,    #for now just a small reward that should encourage the agent to get out of the starting area and discover coins
...
GAME_REWARD_FACTORS_PROCESSED = {
    ...
    E_MOVED_TOWARDS_CRATE: 0,
    E_MOVED_AWAY_FROM_CRATE: 0,
