...
class ReplayBuffer():
    ...
    """
    Stores a transition
    :param old_state: 1D np array
    :param action_index: integer representation of action
    :param reward: TODO
    :param new_state: 1D np array
    :param termination_flag: TODO
    """
    ...
    def sample(self, batch_size):
        ...
        batch_termination_flag = T.tensor(self.buffer_termination_flag[random_indices], device=self.device)
